    ...
    return when (val classifier = classifier) {
        is JavaClass -> {
            ...
            val mappedTypeArguments = if (isRaw) {
                mappedTypeParameters?.createRawArguments(session, lowerBound != null)
...
private fun List<FirTypeParameterRef>.createRawArguments(session: FirSession, forUpperBound: Boolean): List<ConeTypeProjection> {
